...
const DETAIL_I18N_KEYS: Record<string, string> = {
  ...
  'Invalid invite code': 'portal.inviteCodeInvalid',
  'Incorrect old password': 'portal.profile.incorrectOldPassword',
  'New password must differ from old password': 'portal.profile.passwordUnchanged',
