  ...
  <el-card class="host-card" shadow="never">
    <template #header>
      <div class="host-header">
        ...
        />
        <div class="dk-spacer" />
        <el-switch v-model="host.is_disabled" :active-text="t('status.disabled')" inline-prompt />
    ...
    <el-form label-position="top">
      <div class="grid-2">
        ...
        <el-form-item :label="t('hostsDialog.port')">
          <el-input-number v-model="host.port" :min="0" :controls="false" style="width: 100%" />
        </el-form-item>
      </div>
      ...
      <div class="grid-3">
        ...
        <el-form-item :label="t('hostsDialog.alpn')">
          <el-select v-model="host.alpn" style="width: 100%">
            <el-option v-for="a in ALPN_OPTIONS" :key="a" :label="a || 'default'" :value="a" />
          </el-select>
        </el-form-item>
      ...
      <el-collapse>
        <el-collapse-item :title="t('hostsDialog.advancedOptions')">
          ...
          <el-form-item :label="t('hostsDialog.noise')">
            <el-input v-model="host.noise_setting" :placeholder="t('hostsDialog.noise.info')" />
          </el-form-item>
          <div class="switches">
